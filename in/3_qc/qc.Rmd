...
barcodes = read.table("../../Analysis/atlas_data/atlas/barcodes.tsv", stringsAsFactors = F)[,1]
#exp_design = read.table("../../Analysis/atlas_data/atlas/sample_stage_map.csv", sep = ",", header = TRUE)
...
split_bc = strsplit(as.character(barcodes), "_", fixed = T)
